...
config.MIN_CHANGE = 5; //mimum value of a spike to be considered a switch (5)

//Analysis Settings
config.MIN_SPIKETRADE = 1; //rebound size to consider a trade (1)
config.ALERTRANK = 4; //minimum switches for a market to be tradable (4)
